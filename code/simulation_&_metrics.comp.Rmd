...
plot_spp_richness <- function(net_list, pres_mat) {
  
  timesteps <- 1:length(net_list)
...
```{r}
p1 <- plot_spp_richness(net_list = results$network_list, pres_mat = results$presence_matrix)
plot_spp_richness(net_list = results$network_list, pres_mat = results$presence_matrix)
```
