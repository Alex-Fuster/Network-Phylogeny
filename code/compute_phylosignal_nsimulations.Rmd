...
#saveRDS(cor_fac, "../data/results_nsim_fac_6d.RDS")
...
#saveRDS(cor_fw, "../data/results_nsim_fw_6d.RDS")
...
#saveRDS(cor_comp, "../data/results_nsim_comp_6d.RDS")
...
#saveRDS(cor_n, "../data/results_nsim_neutral_6d.RDS")
...
cor_fac <- readRDS("../data/results_nsim_fac_6d.RDS")
cor_comp <- readRDS("../data/results_nsim_comp_6d.RDS")
cor_n <- readRDS("../data/results_nsim_neutral_6d.RDS")
...
p_fac <- ggplot(df_fac, aes(x = timesteps, y = phylo.cor.mean, group = sim, col = sim))+
geom_line(color= df_fac$sim, linetype="solid",alpha = 0.7)+
