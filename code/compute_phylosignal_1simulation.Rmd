...
list_res <- readRDS("../data/neutral/list_res_n_3.rds")
...
**NOTE** sometimes one simulation may have a problem with the spp in the phylogeny and the spp present in maybe only 1 timestep. Not sure why. But it doesnt happen in the majority of simulations.
...
list_interact_distances_pred[[1]]
