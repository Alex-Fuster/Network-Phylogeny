...
#
#require(ape)
#my.tree=rtree(20, rooted = TRUE, tip.label = NULL, br = runif) #random tree in phylo format
#plot(my.tree) # plot tree
#Ntips=length(my.tree$tip.label) #number of spp/tips
#
#tt.mytree <-timetree(my.tree)
#
#gamma.ape=gammaStat(tt.mytree) #calculating gamma with ape package
#
#alpha.calc=alpha_value(Ntips,gamma.ape)
#
#
#alpha.calc=alpha_value(41,5.468193)
