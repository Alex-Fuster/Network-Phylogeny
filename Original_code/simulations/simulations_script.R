...
#save(reccorded_seed_pos_list, file = "Data/Positive_interactions/reccorded_seed_pos_list1.Rdata")
#save(reccorded_seed_neg_list, file = "Data/Negative_interactions/reccorded_seed_neg_list1.Rdata")
