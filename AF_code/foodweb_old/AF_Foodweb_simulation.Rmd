...
#for(b in 1:10){
	...
	b <- 1
		...
		# Save simulations results data
			...
			path <- paste0("../AF_Data/foodweb/list_res_foodweb_", nsim, ".Rdata")
...
for (i in 1:20) {
  	...
  	#	if(success >= 20){
    		...
    		print(paste("simulation ", successful_sim, "sur", nsim))
    		successful_sim <- successful_sim + 1 # Count the amount of simulations
  		}
		...
		# Save simulations results data
			...
			path <- paste0("../AF_Data/Testing/list_res_foodweb", nsim, ".Rdata")
...
```{r}
save(reccorded_seed_pos_list, file = "AF_Data/Testing/reccorded_seed_pos_list1.Rdata")
save(reccorded_seed_neg_list, file = "AF_Data/Testing/reccorded_seed_neg_list1.Rdata")
save(needed_sim_pos, file = "Data/Testing/needed_sim_pos1.Rdata")
save(needed_sim_neg, file = "Data/Testing/needed_sim_neg1.Rdata")
...
load("../AF_Data/Testing/list_res_foodweb2.Rdata")

names(list_res) = paste0("simulation", 1:20)
...
timesteps <- length(list_simulation1$list_anc_dist)



df.spp.richness <- data.frame(n_spp_time, timesteps)




p.spp <- ggplot(df.spp.richness, aes(x=timesteps, y = n_spp_time)) +
